...
var test_grid3 = "800000000003600000070090200050007000000045700000100030001000068008500010090000400";
console.time("solve sudoku puzzle");
console.log(board_string(search(parse_grid(test_grid3))));
console.timeEnd("solve sudoku puzzle");
